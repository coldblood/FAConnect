...
namespace Microsoft.BotBuilderSamples.Dialogs
{
    public class MainDialog : ComponentDialog
    {
        ...
        public MainDialog(FAConnectIntentRecognizer luisRecognizer, BookingDialog bookingDialog, ILogger<MainDialog> logger)
        ...
        private async Task<DialogTurnResult> HandleFAConnect(WaterfallStepContext context, CancellationToken cancellationToken) {
            ...
            switch (luisResult.TopIntent().intent)
            {
                case FAConnect.Intent.Summary:
                    response = "The average portfolio value is 10 million";
                    break;
